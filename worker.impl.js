/* Root minimal fallback worker.impl.js - BRPOP loop and logging */
...
async function main() {
  try {
    ...
    console.info('ROOT_FALLBACK_WORKER_STARTED', { ts: new Date().toISOString(), redis: !!url });
    ...
    console.error('ROOT_FALLBACK_FATAL', e && (e.stack||e.message||String(e)));
    process.exit(1);
  }
}
